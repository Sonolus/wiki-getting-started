...
[Sonolus_0.5.13.ipa](https://sonolus.com/download/Sonolus_0.5.13.ipa)をダウンロードして上記のいずれかを使用すると、 サイドロードできます。
...
[Sonolus_0.5.13.ipa](https://sonolus.com/download/Sonolus_0.5.13.ipa) をダウンロードして、開くとインストールできます。
