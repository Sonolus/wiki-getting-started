...
[Sonolus_0.5.10.ipa](https://sonolus.com/download/Sonolus_0.5.10.ipa)をダウンロードして上記のいずれかを使用すると、 サイドロードできます。
...
[Sonolus_0.5.10.ipa](https://sonolus.com/download/Sonolus_0.5.10.ipa) をダウンロードして、開くとインストールできます。
