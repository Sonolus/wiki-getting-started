...
[Sonolus_0.7.3.ipa](https://download.sonolus.com/Sonolus_0.7.3.ipa)をダウンロードして上記のいずれかを使用すると、 サイドロードできます。
...
[Sonolus_0.7.3.ipa](https://download.sonolus.com/Sonolus_0.7.3.ipa) をダウンロードして、開くとインストールできます。
