...
[Sonolus_0.7.5.ipa](https://download.sonolus.com/Sonolus_0.7.5.ipa)をダウンロードして上記のいずれかを使用すると、 サイドロードできます。
...
[Sonolus_0.7.5.ipa](https://download.sonolus.com/Sonolus_0.7.5.ipa) をダウンロードして、開くとインストールできます。
