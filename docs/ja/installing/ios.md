...
[Sonolus_0.5.12.ipa](https://sonolus.com/download/Sonolus_0.5.12.ipa)をダウンロードして上記のいずれかを使用すると、 サイドロードできます。
...
[Sonolus_0.5.12.ipa](https://sonolus.com/download/Sonolus_0.5.12.ipa) をダウンロードして、開くとインストールできます。
