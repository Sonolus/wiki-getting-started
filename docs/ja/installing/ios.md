...
[Sonolus_0.8.7.ipa](https://download.sonolus.com/Sonolus_0.8.7.ipa)をダウンロードして上記のいずれかを使用すると、 サイドロードできます。
...
[Sonolus_0.8.7.ipa](https://download.sonolus.com/Sonolus_0.8.7.ipa) をダウンロードして、開くとインストールできます。
