...
[Sonolus_0.8.1.ipa](https://download.sonolus.com/Sonolus_0.8.1.ipa)をダウンロードして上記のいずれかを使用すると、 サイドロードできます。
...
[Sonolus_0.8.1.ipa](https://download.sonolus.com/Sonolus_0.8.1.ipa) をダウンロードして、開くとインストールできます。
