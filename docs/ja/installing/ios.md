...
[Sonolus_0.8.4.ipa](https://download.sonolus.com/Sonolus_0.8.4.ipa)をダウンロードして上記のいずれかを使用すると、 サイドロードできます。
...
[Sonolus_0.8.4.ipa](https://download.sonolus.com/Sonolus_0.8.4.ipa) をダウンロードして、開くとインストールできます。
