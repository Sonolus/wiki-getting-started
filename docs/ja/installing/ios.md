...
[Sonolus_0.5.11.ipa](https://sonolus.com/download/Sonolus_0.5.11.ipa)をダウンロードして上記のいずれかを使用すると、 サイドロードできます。
...
[Sonolus_0.5.11.ipa](https://sonolus.com/download/Sonolus_0.5.11.ipa) をダウンロードして、開くとインストールできます。
