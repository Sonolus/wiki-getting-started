...
使用任何此类工具下载并侧载 [Sonolus_0.8.0.ipa](https://download.sonolus.com/Sonolus_0.8.0.ipa) 。
...
使用任何此类服务下载并侧载 [Sonolus_0.8.0.ipa](https://download.sonolus.com/Sonolus_0.8.0.ipa) 。
...
越狱后，下载并安装 [Sonolus_0.8.0.ipa](https://download.sonolus.com/Sonolus_0.8.0.ipa) 。
