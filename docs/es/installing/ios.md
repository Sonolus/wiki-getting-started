...
Descarga y hazle un sideload (descarga lateral) a [Sonolus_0.7.0.ipa](https://sonolus.com/download/Sonolus_0.7.0.ipa) usando cualquiera de esas herramientas.
...
Descarga y hazle un sideload (descarga lateral) a [Sonolus_0.7.0.ipa](https://sonolus.com/download/Sonolus_0.7.0.ipa) usando cualquiera de esos servicios.
...
Descarga e instala [Sonolus_0.7.0.ipa](https://sonolus.com/download/Sonolus_0.7.0.ipa) después de hacer un jailbreak.
