...
Descarga y hazle un sideload (descarga lateral) a [Sonolus_0.6.3.ipa](https://sonolus.com/download/Sonolus_0.6.3.ipa) usando cualquiera de esas herramientas.
...
Descarga y hazle un sideload (descarga lateral) a [Sonolus_0.6.3.ipa](https://sonolus.com/download/Sonolus_0.6.3.ipa) usando cualquiera de esos servicios.
...
Descarga e instala [Sonolus_0.6.3.ipa](https://sonolus.com/download/Sonolus_0.6.3.ipa) después de hacer un jailbreak.
